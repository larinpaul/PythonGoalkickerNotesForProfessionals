...
# sequence using their references. Linkes lists can be used tp implement more complex data structues like lists,
# stacks, queues, and associative arrays.


## Section 24.1: Signle linked list example
...
class LinkedList:
    ...
    def search(self, item):
        """Search for item in list. If found, return True. If not foundm, return False"""
        current = self.head
        found = False
    ...
    def pop(self, position = None):
        ...
        Ifp position is provided, return and remove the item at that position.
        If index is outo f bounds, raise IndexError
        """
    ...
    def append(self, item):
        """Append item to teh end of the list"""
        current = self.head
        previous = None
        pos = 0
        length = self.size()
...
### 11:33 ### It took me 18 minutes to write 190 lines of code.
